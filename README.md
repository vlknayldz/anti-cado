...
Uygulama açıldığında tam ekran panel gelir. Sağ üst köşede küçük, sabit boyutlu ve tamamen CLI karakterleriyle çizilmiş Fenerbahçe amblemi bulunur. Amblem; sarı-lacivert çizgileri, beyaz dış halkayı, kırmızı iç halkayı, sarı-lacivert merkezi, yeşil yaprağı ve `1907` detayını taşır. JPEG veya terminal görüntü protokolü kullanılmaz. Kural satırları ve alt düğmeler fareyle tıklanabilir; klavye kısayolları da her zaman kullanılabilir:
